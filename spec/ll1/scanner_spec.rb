...
describe RDF::LL1::Scanner do
  describe ".new" do
    ...
    it "passes input data to block" do
      block_called = false
      scanner = RDF::LL1::Scanner.new(StringIO.new("foo")) do |string|
        block_called = true
        "bar"
      end
  ...
  describe "#rest" do
    it "returns remaining scanner contents if not at eos" do
      scanner = RDF::LL1::Scanner.new(StringIO.new("foo\n"))
  ...
  describe "#scan" do
    context "simple terminals" do
      it "returns a word" do
        scanner = RDF::LL1::Scanner.new(StringIO.new("foo bar"))
